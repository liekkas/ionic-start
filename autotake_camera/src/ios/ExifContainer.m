...
- (void)setExifData:(NSMutableDictionary *) dic {
    [self.imageMetadata setValue: dic forKey:(NSString*)kCGImagePropertyExifDictionary];
}

- (void) setTIFFData:(NSMutableDictionary *)dic {
    [self.imageMetadata setValue: dic forKey:(NSString*)kCGImagePropertyTIFFDictionary];
}
